...
extension BaseDigits {
    ...
    @inlinable
    static subscript(remainder: UInt8, as _: Unicode.Scalar.Type = Unicode.Scalar.self) -> Unicode.Scalar {
        .init(Self[remainder])
    }

    /// Gets the ASCII value for the given remainder as a ``Character``.
    @inlinable
    static subscript(remainder: UInt8, as _: Character.Type = Character.self) -> Character {

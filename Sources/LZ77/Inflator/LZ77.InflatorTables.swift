...
extension LZ77.InflatorTables {
    init(literals: LZ77.HuffmanTree<UInt16>, distances: LZ77.HuffmanTree<UInt8>) {
        ...
        self.storage.withUnsafeMutablePointerToElements { (base: UnsafeMutablePointer<UInt8>) in
            ...
            (base + start).withMemoryRebound(to: LZ77.RunLiteral.self, capacity: literals.size.z) {
                literals.table(initializing: $0)
            }
            (base + offset).withMemoryRebound(to: LZ77.Distance.self, capacity: distances.size.z) {

...
extension LZ77
{
    ...
    public struct Deflator {
        private var buffers: DeflatorBuffers<LZ77.Format>

        public init(format: LZ77.Format = .zlib, level: Int, exponent: Int = 15, hint: Int = 1 << 12) {
...
extension LZ77.Deflator {
    public mutating func push(_ data:ArraySlice<UInt8>, last:Bool = false) {
